...
api_key<-jsonlite::fromJSON(here::here("precious-metals","quandl_api.json"))[[1]]
...
invisible(sapply(list.files(here::here("precious-metals","src","reports"),pattern = "*.R",full.names = T),source,local=F))
...
if (!file.exists(here::here("data","si_f.RDS"))) {
  ...
  GC_F%<>%
    ...
    saveRDS(GVS_F,here::here("precious-metals","data","gvs_f.RDS"))
  saveRDS(SI_F,here::here("precious-metals","data","si_f.RDS"))
  saveRDS(GC_F,here::here("precious-metals","data","gc_f.RDS"))

} else{
  SI_F <- readRDS(here::here("precious-metals","data","si_f.RDS"))
  GC_F <- readRDS(here::here("precious-metals","data","gc_f.RDS"))
